...
class CompetenciasExperiencias extends Entity {

    //Atributo estático, nombre de tabla
    protected static $table = 'competenciasExperiencias';

    //array estático para almacenar las columnas de la tabla
    protected static $columnsDB = ['id', 'idExperiencia', 'idCompetencia'];
    ...
    public function __construct($args = []){
        ...
        $this->idExperiencia = $args['idExperiencia'] ?? null;
