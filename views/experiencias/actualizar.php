...
<main id="formularioExperiencias" class="contenedor ptb-4">
    ...
    <form method="POST" class="formulario">
        ...
        <fieldset>
            ...
            <input type="text" name="entornos" id="entornos" placeholder="Ej: Iberdrola, El Corte Inglés, etc."<?php echo $experiencia->entornos ? "value='$experiencia->entornos'" : ''; ?>>
        ...
        <input class="boton boton-azul" type="submit" value="Actualizar Experiencia">
    </form>
</main>