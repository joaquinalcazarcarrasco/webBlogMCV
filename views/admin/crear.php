            ...
            <form class="form-creating-news" method="POST" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <?php if($news->image && file_exists(DIR_IMAGES . $news->image)): ?>
                        ...
                        <img loading="lazy" src="/images/imgNews/<?php echo $news->image; ?>" class="uploaded-image" alt="News Image">

                    <?php endif; ?>
                    <label>Contenido*</label>
                    <textarea name="entry" id="editor">
                        <?php echo sanitise($news->entry); ?>
                    </textarea>

                    <div class="text-right mt2">
                        <input type="submit" id="submitNews" name="submitNews" class="button green" value="Crear">
                    </div>
                </fieldset>
            </form><!--.news-->
            <div class="mt2">
